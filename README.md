# CoreTech (AI-MCP 협업 프로젝트)

---

## ✨ 주요 기능
- 🏠 **개인화된 홈**: 공지사항, 퀴즈 진행률, 즐겨찾기·최근 풀이 문제, Q&A/게시판 하이라이트  
- 📝 **데일리 퀴즈**: Linux·Server Ops·Network·Database 각 50문제, 풀이 여부 저장, 오답노트·즐겨찾기, 정답률 통계
- 💬 **커뮤니티 도구**: 게시판, Q&A, 태그, 댓글, 좋아요, 조회수, 답변 채택·검색/정렬 기능, 강의/문제 연계 토론  
- 📚 **구조화된 강의 자료**: Markdown 기반 커리큘럼, 학습 진행률, 강의 내 퀴즈/예제 연동, 북마크  
